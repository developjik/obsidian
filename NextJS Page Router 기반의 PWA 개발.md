...
`PWA(Progressive Web Application)`는 웹과 네이티브 앱의 장점을 결합한 애플리케이션 형태입니다. 기존 웹 애플리케이션에 새로운 기능을 추가하여 사용자가 웹사이트를 마치 네이티브 앱처럼 사용할 수 있게 만드는 기술입니다. PWA는 웹 표준을 기반으로 하며, 주로 다음과 같은 기능을 포함합니다:
...
3. **HTTPS:** 보안을 위해 모든 PWA는 HTTPS에서만 동작합니다.
